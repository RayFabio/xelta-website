  ...
  return <main className="home-scroll bg-slate-950 text-white">
    <section className="home-hero relative flex min-h-screen items-center justify-center overflow-hidden">
      ...
      <div className="home-hero-content relative z-10 max-w-5xl px-6 text-center">
        ...
        <h1 className="home-hero-title text-5xl font-black leading-[.86] tracking-[-.07em] sm:text-7xl lg:text-9xl"><span className="home-hero-title-line">build & shape</span><span className="home-hero-title-mark">your</span><span className="home-hero-title-line home-hero-title-accent">future</span></h1>
