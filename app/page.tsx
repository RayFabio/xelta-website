  ...
  return <main className="home-scroll bg-slate-950 text-white">
    <section className="home-hero relative flex min-h-screen items-center justify-center overflow-hidden">
      ...
      <div className="home-hero-content relative z-10 max-w-5xl px-6 text-center">
        ...
        <h1 className="home-hero-title text-5xl font-black leading-[.86] tracking-[-.07em] sm:text-7xl lg:text-9xl"><span className="home-hero-title-line">we build & shape</span><span className="home-hero-title-mark">your</span><span className="home-hero-title-line home-hero-title-accent">future</span></h1>
        ...
        <div className="mt-10 flex flex-wrap justify-center gap-4">
          ...
          <Link href="/adikarya" className="home-button home-button-secondary inline-flex">XELTA Adikarya</Link>
        </div>
      </div>
    </section>
    ...
    <section className="border-t border-slate-800 bg-amber-400 px-6 py-32 text-slate-950"><div className="mx-auto max-w-6xl reveal-card"><p className="text-xs font-bold uppercase tracking-[.3em] text-amber-950">Start a new chapter</p><h2 className="mt-6 max-w-4xl text-5xl font-black leading-[.9] tracking-[-.06em] sm:text-8xl">Let&apos;s build<br />what&apos;s next.</h2><Link href="/contact" className="home-dark-button mt-12 inline-flex">Start a conversation ↗</Link></div></section>
  </main>;
}
