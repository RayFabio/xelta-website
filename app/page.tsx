...
export default function Home() {
  ...
  return <main className="home-scroll bg-slate-950 text-white">
    <section className="home-hero relative flex min-h-screen items-center justify-center overflow-hidden"><div className="home-hero-bg" /><div className="home-hero-grid" /><div className="home-hero-content relative z-10 max-w-5xl px-6 text-center"><img className="home-main-logo" src="/xelta-logo.svg" alt="XELTA" /><p className="mb-6 text-xs font-bold uppercase tracking-[.35em] text-amber-400">Building future innovators</p><h1 className="text-5xl font-black leading-[.9] tracking-[-.07em] sm:text-7xl lg:text-9xl">Build boldly.<br /><span className="text-amber-400">Learn deeply.</span></h1><p className="mx-auto mt-8 max-w-2xl text-base leading-8 text-slate-300 sm:text-xl">Bringing civil construction and professional learning together to build a stronger future.</p><Link href="#home-showcase" className="home-button mt-10 inline-flex">Explore XELTA ↓</Link></div><div className="home-scroll-hint">Scroll to discover <span /></div></section>
