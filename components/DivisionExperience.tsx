...
export default function DivisionExperience({ division }: { division: Division }) {
  const isAcademy = division.eyebrow.includes("AKADEMI");
  useEffect(() => {
  ...
  return <main className={`division-scroll division-page bg-slate-950 text-white ${isAcademy ? "division-academy" : ""}`}>
